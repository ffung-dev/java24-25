...
public class Methods
{
      ...
      while (tryAgain) 
      {
         ...
         // factorial of a number
         {
            ...
            while (aDigitNumNegative)
            {
               ...
               System.out.print("Input a nonnegative integer is "+ aDigitNum);
            ...
            // DEBUG: System.out.println(hasMidpoint(midpointNum1, midpointNum2, midpointNum3));

         } else { // user does not choose between 1-5
            System.out.println("ERROR: did not input a valid option");
         }

         // asks if user wants to rerun code
         System.out.println(divider);
   ...
   // option 4: takes a nonnegative integer and returns the average of the digits in the number
   {
      ...
      while (num > 0)
      {
         // System.out.println("DEBUG: " + num + " " + n);
         sum = sum + (num % 10) ; // remainder of num/10 = digit!
         // System.out.println("DEBUG: sum:" + sum);
         num = num / 10; // dividing by 10 = next digit (unless it becomes a decimal > then exit)         
